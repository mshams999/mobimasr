...
<div id="wplp-settings-content-source">
                    ...
                    <div class="overlay-icon-color float width-50">
                        ...
                        <div id="overIconColor" class="wplp-pick-color" data-id="overIconColor">
                            <input id="overIconColor" name="wplp_over_icon_color" class="wplp_colorPicker"
                                   value="<?php echo esc_html(htmlspecialchars(isset($settings['over_icon_color']) ? $settings['over_icon_color'] : '#ff0000')) ?>"/>
                        </div>
                    </div>
                    <div class="button-text-color float">
                        ...
                        <div id="overBGIconColor" class="wplp-pick-color" data-id="overBGIconColor">
                            <input id="overBGIconColor" name="wplp_over_bg_icon_color" class="wplp_colorPicker"
                                   value="<?php echo esc_html(htmlspecialchars(isset($settings['over_bg_icon_color']) ? $settings['over_bg_icon_color'] : '#2C8FC7')) ?>"/>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="overlay-type-field settings-wrapper-field">
                    <div class="overlay-color float width-50">
                        ...
                        <div id="overlayColor" class="wplp-pick-color" data-id="overlayColor">
                            <input id="overlayColor" name="wplp_overlay_color" class="wplp_colorPicker"
                                   value="<?php echo esc_html(htmlspecialchars(isset($settings['overlay_color']) ? $settings['overlay_color'] : 'transparent')) ?>"/>
                        </div>
                    </div>
                    <div class="overlay-tranparancy float">
                        ...
                        <input id="overlayTransparent" type="text" name="wplp_overlay_transparent" style="width: 25%;"
                               value="<?php echo esc_html(htmlspecialchars(isset($settings['overlay_transparent']) ? $settings['overlay_transparent'] : '0')) ?>"
                               class="wplp-short-text wplp-font-style center-text" />
                    </div>
                    <div class="clearfix"></div>
                </div>
    ...
    <div id="text-settings" class="tab-content">
        <div class="settings-wrapper">
            ...
            <div class="clearfix"></div>
            <div class="more-btn-property settings-wrapper-field">
                <?php
                if (class_exists('WPLPAddonAdmin')) {
                    do_action('wplp_addon_theme_display_loadmore_button', $settings);
                }
                ?>
                <div class="lazyloading-btn float width-50">
                    <?php
                    if (isset($settings['layzyload_default'])) {
                        $layzyload_default_checked[$settings['layzyload_default']] = ' checked="checked"';
                    }
                    ?>
                    <label class="settings-wrapper-title"><?php esc_html_e('Lazy load image', 'wp-latest-posts') ?></label>
                    <ul class="un-craft col-li-4">
                        <li>
                            <input type="radio" name="wplp_layzyload_default" id="lazyload_default1" value="1" class="ju-radiobox"
                                <?php echo (isset($layzyload_default_checked[1]) ? esc_html($layzyload_default_checked[1]) : ''); ?> />
                            <label for="lazyload_default1" class="radio-label"><?php esc_html_e('On', 'wp-latest-posts') ?></label>
                        </li>
                        <li>
                            <input type="radio" name="wplp_layzyload_default" id="lazyload_default2" value="0" class="ju-radiobox"
                                <?php echo (isset($layzyload_default_checked[0]) ? esc_html($layzyload_default_checked[0]) : ''); ?> />
                            <label for="lazyload_default2" class="radio-label"><?php esc_html_e('Off', 'wp-latest-posts') ?></label>
                        </li>
                    </ul>
                </div>
                <div class="clearfix"></div>
            ...
            <div class="number-element settings-wrapper-field">
                ...
                <div class="number-ele float col-li-4">
                    <label class="settings-wrapper-title"><?php esc_html_e('Max number of elements', 'wp-latest-posts') ?></label>
                    <input id="max_elts" type="text" name="wplp_max_elts" class="wplp-short-text wplp-font-style wplp-short-input center-text"
                           value="<?php echo esc_html(htmlspecialchars(isset($settings['max_elts']) ? $settings['max_elts'] : '5')) ?>" />
                </div>
                <div class="clearfix"></div>
            </div>
            <hr>
